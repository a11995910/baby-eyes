# Baby Eyes Save - Android护眼监测应用

## 项目简介
Baby Eyes Save是一款专为保护儿童视力健康而设计的Android应用程序。通过智能监测和提醒功能，帮助家长和孩子养成良好的用眼习惯。
...
├── app/                          # 主应用模块
│   ├── src/main/
│   │   ├── java/wjcom/example/inc/
│   │   │   ├── MainActivity.kt           # 主活动
│   │   │   ├── FirstFragment.kt          # 第一个片段
│   │   │   ├── SecondFragment.kt         # 第二个片段
│   │   │   ├── service/
│   │   │   │   └── EyeProtectionService.kt  # 护眼服务
│   │   │   ├── ui/
│   │   │   │   └── FloatingWindowManager.kt # 悬浮窗管理器
│   │   │   └── utils/
│   │   │       ├── DistanceCalculator.kt    # 距离计算工具
│   │   │       └── SharedPrefsManager.kt   # 偏好设置管理
│   │   ├── res/                     # 资源文件
│   │   │   ├── drawable/            # 图标和背景
│   │   │   ├── layout/              # 布局文件
│   │   │   ├── values/              # 字符串、颜色、尺寸
